...
public class PlayerAnimator : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (movement.moveDirection != Vector3.zero) // Ensure moveDirection is not zero to avoid look rotation to zero direction.
        {
    ...
    public void AnimationStateMachine()
    {
        ...
        {
            Quaternion targetRotation = Quaternion.LookRotation(movement.moveDirection);
            movement.aimIndicator.rotation = Quaternion.Slerp(movement.aimIndicator.rotation, targetRotation, Time.deltaTime * rotationSpeed);
        }
    ...
    private void LeanTowardsMoveDirection()
    {
        ...
        bodySprite.rotation = Quaternion.Lerp(bodySprite.rotation, targetRotation, Time.deltaTime * rotationSpeed);
    }
